...
@Component({
  templateUrl: './bbp-compliance-page.component.html',
  styleUrls: ['./bbp-compliance-page.component.scss'],
})
export class BbpCompliancePageComponent implements OnInit {
  ...
  constructor(
    ...
    this.hipaaUrl = this.config.getStaticEndPoint(environment.bbpTrainingDoc);
  }
